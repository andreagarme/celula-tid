...
<main class="container mt-24 mb-32">
	<section>
		...
		<div class="grid grid-cols-1 xl:grid-cols-2 gap-32 mt-12">
			<div>
				<img
					src="https://images.pexels.com/photos/17848710/pexels-photo-17848710/free-photo-of-animal-black-portrait-horses.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
					alt="Lorem ipsum"
